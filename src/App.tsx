...
export function App() {
  ...
  React.useEffect(() => {
    const handleVisibilityChange = () => {
      ...
      } else if (!document.hidden && settings.enableAMOLEDSaver && !reducedMotion) {
        // Resume drift
        const driftInterval = setInterval(() => {
          setDriftOffset(generateRandomDrift())
        }, 45000)
  ...
  }, [settings.enableAMOLEDSaver, settings.backgroundMode, settings.gradientStart, settings.gradientEnd, settings.solidColor, reducedMotion])
